...
<head>
   ...
   // queue_css_url('https://fonts.googleapis.com/css?family=Archivo+Black|Assistant:200,300,400'); // using font from original ajamarchive site
    queue_css_url('https://fonts.googleapis.com/css?family=Karla');
    echo head_css();
...
<div class="ajam-sidebar">
<!-- sidebar contents temporarily removed -->  

<!-- nia trying to get search in sidebar to disappear while on items/search page -->
<?php
// When header is on main page (URL of '/'),
//    show the Advanced Search link.
if (is_current_url('/items/search')) {
 echo '<a href="/ajamarchive">&larr; Back to Browse</a>' ;
}
else {
    include 'nia-sidebar-search.php';
}
?>
<!-- nia -->   
</div>